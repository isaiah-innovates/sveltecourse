import{d as pd,w as os}from"./index.Biuj0nYx.js";var la={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fd="storage";function kT(t,e,n){return t=B(t),JE(t,e,n)}function DT(t){return t=B(t),YE(t)}function NT(t,e){return t=B(t),nT(t,e)}function iT(t=js(),e){t=B(t);const r=ti(t,fd).getImmediate({identifier:e}),i=qc("storage");return i&&sT(r,...i),r}function sT(t,e,n,r={}){rT(t,e,n,r)}function oT(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),r=t.getProvider("auth-internal"),i=t.getProvider("app-check-internal");return new ua(n,r,i,e,Pt)}function aT(){Tt(new tt(fd,oT,"PUBLIC").setMultipleInstances(!0)),Ce(Mc,xc,""),Ce(Mc,xc,"esm2017")}aT();const cT={apiKey:"AIzaSyAFhWyDrYZIO6eOW88fCWTYShemEIcRuao",authDomain:"sveltecourse-21d6d.firebaseapp.com",projectId:"sveltecourse-21d6d",storageBucket:"sveltecourse-21d6d.appspot.com",messagingSenderId:"746758127975",appId:"1:746758127975:web:5ea0a62f1176aa66a5efc2"};Qc(cT);const uT=x_(),fn=Qv(),VT=iT();function lT(){let t;if(!fn||!globalThis.window){console.warn("Auth is not initialized or not in browser");const{subscribe:n}=os(null);return{subscribe:n}}const{subscribe:e}=os((fn==null?void 0:fn.currentUser)??null,n=>(t=Uy(fn,r=>{n(r)}),()=>t()));return{subscribe:e}}const hT=lT();function dT(t){let e;const n=L_(uT,t),{subscribe:r}=os(null,i=>(e=W_(n,s=>{i(s.data()??null)}),()=>e()));return{subscribe:r,ref:n,id:n.id}}const OT=pd(hT,(t,e)=>{if(t)return dT(`users/${t.uid}`).subscribe(e);e(null)});export{Ge as G,hT as a,CT as b,fn as c,VT as d,kT as e,AT as f,DT as g,L_ as h,uT as i,TT as j,RT as k,_T as l,ET as m,vT as n,IT as o,wT as p,yT as q,NT as r,bT as s,ST as t,OT as u,PT as w};
